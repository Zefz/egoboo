...
//  image = cartman_CreateSurface( SDL_SWSURFACE, w, h, 32, 0x000000ff, 0x0000ff00, 0x00ff0000, 0xff000000 );
//#else
//  image = cartman_CreateSurface( SDL_SWSURFACE, w, h, 32, 0xff000000, 0x00ff0000, 0x0000ff00, 0x000000ff );
//#endif
//
//  if ( image == NULL )
//  {
...
//  area.w = surface->w;
//  area.h = surface->h;
//  SDL_BlitSurface( image, &area, surface, &area );
//
...
//
//
//SDL_Surface * fnt_printf( Font *font, int x, int y, SDL_Color color, const char *format, ... )
//{
//  char * msg;
//  va_list args;
//
...
//  va_end( args );
//
//  TTF_RenderText_Blended( font->ttfFont, msg, color );
//}
