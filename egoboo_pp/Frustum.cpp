...
void CFrustum::CalculateFrustum(float proj[], float modl[])
{    
...
bool CFrustum::BBoxInFrustum( float corner1[], float corner2[])
{
  if(NULL==corner1 || NULL==corner2) return true;

  float x,y,z;
	for(int i = 0; i < 6; i++ )
	{
		if(m_Frustum[i][A] * corner1[0] + m_Frustum[i][B] * corner1[1] + m_Frustum[i][C] * corner1[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner1[0] + m_Frustum[i][B] * corner1[1] + m_Frustum[i][C] * corner2[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner1[0] + m_Frustum[i][B] * corner2[1] + m_Frustum[i][C] * corner1[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner1[0] + m_Frustum[i][B] * corner2[1] + m_Frustum[i][C] * corner2[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner2[0] + m_Frustum[i][B] * corner1[1] + m_Frustum[i][C] * corner1[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner2[0] + m_Frustum[i][B] * corner1[1] + m_Frustum[i][C] * corner2[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner2[0] + m_Frustum[i][B] * corner2[1] + m_Frustum[i][C] * corner1[2] + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * corner2[0] + m_Frustum[i][B] * corner2[1] + m_Frustum[i][C] * corner2[2] + m_Frustum[i][D] > 0)
		   continue;
