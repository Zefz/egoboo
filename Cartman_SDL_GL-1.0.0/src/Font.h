...
//extern void fnt_printf(SDL_Surface * surface, TTF_Font * font, int x, int y, SDL_Color color, const char * format, ...);

extern void fnt_printf_SDL( SDL_Surface * surface, TTF_Font * font, int x, int y, SDL_Color color, const char * format, ... );
extern void fnt_printf_OGL( Font * font, int x, int y, const char * format, ... );